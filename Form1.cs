...
namespace RuntimeFunctions
{
    public partial class Form1 : Form
    {
        ...
        private bool drawFibonacci = true;//true;
        ...
        private void DrawGraph(Graphics gr, float xmin, float xmax, float ymin, float ymax, int ticDx, int ticDy, bool useColor)
        {
            ...
            {
                using (Font small_font = new Font(FontFamily.GenericSansSerif, 10, FontStyle.Regular))
                {
                    DrawRotatedText(gr, font, Brushes.Blue, "Log N", 414, 440, -8, useColor);
                    DrawRotatedText(gr, font, Brushes.Green, "Sqrt N", 410, 390, -11, useColor);
                    DrawRotatedText(gr, font, Brushes.Black, "N", 360, 200, -45, useColor);
                    DrawRotatedText(gr, font, Brushes.Orange, "N", 242, 140, -75, useColor);
                    DrawRotatedText(gr, small_font, Brushes.Orange, "2", 242, 120, -75, useColor);
                    DrawRotatedText(gr, font, Brushes.Fuchsia, "2", 200, 135, -85, useColor);
                    DrawRotatedText(gr, small_font, Brushes.Fuchsia, "N", 195, 120, -85, useColor);
                    DrawRotatedText(gr, font, Brushes.Red, "N!", 140, 125, -90, useColor);
